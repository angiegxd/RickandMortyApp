...
class RickAndMortyListAdapter(val rickandmorty :List<Results>): RecyclerView.Adapter<RickAndMortyListAdapter.ViewHolder>() {
    ...
    class ViewHolder(val view: View):RecyclerView.ViewHolder(view){
        fun setViewItem(position: Int, result:Results){
